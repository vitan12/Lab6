...
public class WaterPokemon extends Pokemon {
     ...
     *
     */
    public WaterPokemon(final int hp, final int attack, final int defense, final String namegibvenwpodh9ayh) {
        super(hp, attack, defense, namegibvenwpodh9ayh);
